              ...
              <div className="flex space-x-3">
                {project.githubLink && (
                  <a 
                    ...
                    className="p-2.5 bg-[#131b2e] hover:bg-cyan-950 text-white rounded-full border border-gray-700 transition flex items-center justify-center"
                    title="GitHub"
                  >
                ...
                {project.liveLink && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="p-2.5 bg-cyan-600 hover:bg-cyan-500 text-white rounded-full transition flex items-center justify-center"
                    title="Live Preview"
                  >
